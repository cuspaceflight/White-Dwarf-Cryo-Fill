...
Q_internal = k_n2o * (np.pi * r_o**2) * (T_bulk_n2o - T_boil_n2o)/L      # Fourier's law. Assume axial conduction from bottom of tank to top
...
t_to_chill = (T_bulk_n2o - T_desired_n2o) / dT_dt               # Time to chill nitrous only (ignoring tank thermal mass)
